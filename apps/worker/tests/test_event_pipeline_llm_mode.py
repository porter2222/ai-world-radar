...
def rich_detail_body() -> str:
    ...
    return (
        ...
        "这件事之所以受到关注，是因为编码 Agent 可能把 AI 编程工具从辅助问答推进到连续任务执行。\n\n"
        ...
        "如果后续出现稳定实测、企业采用案例或官方 API 能力说明，它会影响个人开发者和研发团队的工具选型。\n\n"
        "后续应观察官方文档、开发者实测和开源项目工作流模板。"
        "更具体地说，要看它是否能在复杂代码库中完成可审查的修改，并与测试、版本控制和团队协作流程稳定配合。"
        "这些结果会决定它是短期新鲜工具，还是能长期进入开发团队日常流程的基础能力。"
    )
