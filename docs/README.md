...
20. `05-实现计划/P1-12 手动日常全流程CLI设计.md`
21. `05-实现计划/P1-12 手动日常全流程CLI实施计划.md`
22. `05-实现计划/后端P1实现计划与功能切片拆解.md`
23. `06-代理任务书/后端P1开发代理任务书.md`
24. `07-验收与运行/后端P1测试记录.md`
25. `07-验收与运行/前端公共页联调说明.md`
...
> P1-12 手动日常全流程 CLI 已完成。前端公共首页和事件详情页可继续基于真实 FastAPI Product API 做页面级联调；后端下一步建议进入运行观察，把 `scripts/run_daily_pipeline.py` 接入本地计划任务或后续后台按钮，并补 source 级失败治理、重试/降级策略和采集统计口径。论文源、X、Reddit、YouTube、强反爬源、DailyEdition、历史归档和队列系统继续后置。
