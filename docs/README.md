...
17. `05-实现计划/后端P1实现计划与功能切片拆解.md`
18. `06-代理任务书/后端P1开发代理任务书.md`
19. `07-验收与运行/后端P1测试记录.md`
20. `07-验收与运行/前端公共页联调说明.md`
...
> 前端公共首页和事件详情页已具备首版代码与联调说明，优先使用真实 FastAPI + PostgreSQL 数据做页面级联调截图和视觉微调；后端侧继续观察真实网络 13 源运行稳定性，补 source 失败重试、调度和成本监控。论文源、X、Reddit、YouTube 和强反爬源继续后置。
