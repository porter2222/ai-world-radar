...
4. `01-产品定义/产品需求文档.md`
5. `02-信息源策略/信息源策略.md`
6. `02-信息源策略/GitHub趋势信号去重与新鲜度策略设计.md`
7. `04-系统设计/Agent系统设计.md`
8. `04-系统设计/技术架构与数据模型设计.md`
9. `04-系统设计/运行日志与观测基座设计.md`
10. `04-系统设计/前端视觉设计与页面原型方案.md`
11. `05-实现计划/P1实施路线图与第一阶段后端数据底座计划.md`
12. `05-实现计划/P1-2 LangGraph工作流与三Agent最小闭环计划.md`
13. `05-实现计划/P1-3 HN与GitHub采集接入新版链路计划.md`
14. `05-实现计划/P1-4 真实LLM Agent节点替换计划.md`
15. `05-实现计划/P1-6 产品接口层与最小API计划.md`
16. `05-实现计划/P1-7 GitHub热门项目与官网源扩展计划.md`
17. `05-实现计划/P1-8 官方与开发者平台公开源扩展计划.md`
18. `05-实现计划/P1-9 全源采集与LLM编辑筛选计划.md`
19. `05-实现计划/P1-10 首页时效窗口与采集调度策略.md`
20. `05-实现计划/P1-11 采集层8小时时效窗口设计.md`
21. `05-实现计划/P1-11 采集层8小时时效窗口实施计划.md`
