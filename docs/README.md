...
18. `superpowers/specs/2026-06-24-采集层8小时时效窗口-design.md`
19. `05-实现计划/后端P1实现计划与功能切片拆解.md`
20. `06-代理任务书/后端P1开发代理任务书.md`
21. `07-验收与运行/后端P1测试记录.md`
22. `07-验收与运行/前端公共页联调说明.md`
